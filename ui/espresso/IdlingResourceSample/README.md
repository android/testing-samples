...
Note that the `espresso-idling-resource` dependency is added into the `implementation` scope. This sample use Android X:
...
If you haven't yet migrate to Android X:
