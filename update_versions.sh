...
runnerVersion="1.5.0-rc01"           # RUNNER_VERSION
monitorVersion="1.6.0-rc01"          # MONITOR_VERSION
rulesVersion="1.5.0-rc01"            # RULES_VERSION
servicesVersion="1.4.2-rc01"         # SERVICES_VERSION
orchestratorVersion="1.4.2-rc01"     # ORCHESTRATOR_VERSION
coreVersion="1.5.0-rc01"             # CORE_VERSION
extJUnitVersion="1.1.4-rc01"         # ANDROIDX_JUNIT_VERSION
extTruthVersion="1.5.0-rc01"         # ANDROIDX_TRUTH_VERSION
espressoVersion="3.5.0-rc01"         # ESPRESSO_VERSION
espressoDeviceVersion="1.0.0-alpha02"  # ESPRESSO_DEVICE_VERSION
