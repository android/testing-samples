...
runnerVersion="1.5.0"           # RUNNER_VERSION
monitorVersion="1.6.0"          # MONITOR_VERSION
...
extJUnitVersion="1.1.4"         # ANDROIDX_JUNIT_VERSION
extTruthVersion="1.5.0"         # ANDROIDX_TRUTH_VERSION
espressoVersion="3.5.0"         # ESPRESSO_VERSION
